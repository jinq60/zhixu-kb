-- =====================================================================
-- Flyway V1 基线：与 backend/sql/mysql-schema.sql 同源（去掉 CREATE DATABASE/USE，
-- Flyway 已连入目标库）。新库由 V1 一次建全；老库走 baseline-on-migrate 跳过 V1，
-- 由 V2 Java 迁移按元数据幂等补齐。修改表结构一律新增版本，禁止改 V1。
-- =====================================================================
